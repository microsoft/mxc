...
- Current schema version: `0.6.0-alpha` (state-aware lifecycle requests use `0.6.0-alpha`; experimental backends targeting `0.7.0-dev` are still under development)
