...
> [!WARNING]
> This repository contains preview code published to enable early integration and feedback on Microsoft Execution Containers. The underlying sandboxes are expected to change as they are under ongoing development towards general availability. There are known cases where the current policies generated by the MXC SDK in this repository are overly permissive and will be addressed in future releases. There are no profiles for MXC that are currently security boundaries.
