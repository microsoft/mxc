...
Production parsing selects an exact registered contract, whose
version-specific adapter produces private normalization input for
`wxc_common`. No rolling whole-request parser or model remains. See
