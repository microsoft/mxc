...
`windows` crate. The build-time check below catches the most common
slip — bumping the workspace `windows` crate without regenerating —
by comparing the workspace version against the recorded
