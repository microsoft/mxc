...
|---|---|---|---|
| `version` | `0.10.0-alpha` | `0.10.0-alpha` | Optional explicit declaration of the registered state-aware contract; other values are rejected by the SDK. |
...
| Field | Type | Description |
|---|---|---|
| `version` | `0.10.0-alpha` | Optional explicit declaration of the registered state-aware contract; other values are rejected by the SDK. |
