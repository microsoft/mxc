...
| Exact `0.9.0-alpha` | `src/core/mxc_config_contract/src/dev/` | Closed mutable development contract and versioned TypeScript drift oracle |
...
`mxc-config.schema.0.9.0-alpha.json` even though the production parser still
