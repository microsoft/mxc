...
```json
{
    ...
    "wslc": {                              // WSL Container settings (v0.10 development contract)
...
- Windows Sandbox and WSLC use development `0.10.0-alpha`.
...
experimental authorization; Windows Sandbox and WSLC do.
