...
The corpus baseline was refreshed again on 2026-09-15 for #1160, whose ten
...
converges across Windows and Linux at 339 equivalent accepts and 14 shared
rejections. The 0.9 removal of `seatbelt.launchMethod` retired
`tests/examples/27_mac_terminal_sandboxed.json`, while #1160 adds ten
Bubblewrap cwd-preflight fixtures that both parsers accept. Both retain no
