...
internal partial struct DiplomatResultMxcDiplomatDiscoveryMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatDiscovery* ok;
    ...
    public unsafe MxcDiplomatDiscovery* Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
