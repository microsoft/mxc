...
internal partial struct DiplomatResultMxcDiplomatOutputStreamMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatOutputStream* ok;
    ...
    public unsafe MxcDiplomatOutputStream* Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
