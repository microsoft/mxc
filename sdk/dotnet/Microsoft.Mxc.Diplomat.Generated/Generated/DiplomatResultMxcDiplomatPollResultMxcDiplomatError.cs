...
internal partial struct DiplomatResultMxcDiplomatPollResultMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatPollResult ok;
    ...
    public MxcDiplomatPollResult Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
