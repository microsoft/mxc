...
internal partial struct DiplomatResultMxcDiplomatRunResultMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatRunResult* ok;
    ...
    public unsafe MxcDiplomatRunResult* Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
