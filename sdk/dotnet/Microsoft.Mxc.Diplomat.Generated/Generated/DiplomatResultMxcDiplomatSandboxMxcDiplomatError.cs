...
internal partial struct DiplomatResultMxcDiplomatSandboxMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatSandbox* ok;
    ...
    public unsafe MxcDiplomatSandbox* Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
