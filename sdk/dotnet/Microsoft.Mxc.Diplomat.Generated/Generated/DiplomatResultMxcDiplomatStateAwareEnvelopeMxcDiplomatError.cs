...
internal partial struct DiplomatResultMxcDiplomatStateAwareEnvelopeMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatStateAwareEnvelope* ok;
    ...
    public unsafe MxcDiplomatStateAwareEnvelope* Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
