...
internal partial struct DiplomatResultMxcDiplomatWaitResultMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal MxcDiplomatWaitResult ok;
    ...
    public MxcDiplomatWaitResult Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
