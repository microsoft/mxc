...
internal partial struct DiplomatResultULongMxcDiplomatError
{
    [StructLayout(LayoutKind.Explicit)]
    private unsafe struct InnerUnion
    {
        [FieldOffset(0)] internal ulong ok;
    ...
    public ulong Ok => IsOk ? _inner.ok : throw new InvalidOperationException("Result does not contain Ok value");
