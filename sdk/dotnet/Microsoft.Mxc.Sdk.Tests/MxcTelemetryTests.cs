...
public sealed class MxcTelemetryTests : IDisposable
{
    ...
    private void WriteConsentRecord(string consent)
    {
        ...
        File.WriteAllText(
            path,
            $$"""{"schemaVersion":2,"consent":"{{consent}}","source":"test","promptedMxcVersion":"0.0.0","promptResourceVersion":2,"promptLocale":"en-US","updatedAtEpoch":0}""");
    }
    ...
    public void RequestConsent_ThenWithdraw_RoundTrips_OnWindows()
    {
        ...
        {
            Assert.Equal(2u, prompt.ResourceVersion);
