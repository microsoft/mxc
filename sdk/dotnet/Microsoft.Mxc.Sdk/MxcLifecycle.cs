...
public static class MxcLifecycle
{
    ...
    public static ProvisionResult ProvisionSandbox(ProvisionSandboxOptions? options = null)
    {
        ...
        return new ProvisionResult
        {
            ...
            CorrelationVector = result["correlationVector"]?.GetValue<string>(),
        };
    }
    ...
    internal static JsonObject BuildStartEnvelope(SandboxId id, StartSandboxOptions? options)
    {
        ...
        ApplyOperationOptions(envelope, options?.CorrelationVector, options?.TelemetryEnabled);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var proc = await Task.Run(() => ExecInSandbox(id, command, options), cancellationToken)
    ...
    private static void ApplyOperationOptions(
        JsonObject envelope,
