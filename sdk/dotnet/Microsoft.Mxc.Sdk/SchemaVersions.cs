...
public static class SchemaVersions
{
    ...
    private const string V0_8_0Alpha = "0.8.0-alpha";
    ...
    public const string StateAware = "0.10.0-alpha";

    /// <summary>Default state-aware version for WSLC.</summary>
    public const string WslcStateAware = "0.10.0-alpha";

    internal static bool IsPublished(string version) =>
        version is Minimum or V0_7_0Alpha or V0_8_0Alpha or LatestStable;

    internal static bool UsesLegacyNetwork(string version) =>
        version is Minimum or V0_7_0Alpha or V0_8_0Alpha;
