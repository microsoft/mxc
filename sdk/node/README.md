...
| `nvx` | (concrete only) | Windows x64 | Experimental | [`docs/nvx-backend-gaps.md`](https://github.com/microsoft/mxc/blob/main/docs/nvx-backend-gaps.md) — structural foundation only; runtime unavailable in Phase 1 |
