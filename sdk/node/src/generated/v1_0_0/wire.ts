 ...
 *
 * Emitted from the exact MXC 1.0.0 contract by
 * mxc_schema_gen. This is a drift oracle, not public API, and is not exported
 * from the SDK.
 *
 * Regenerate with:
 *   cargo run --manifest-path src/Cargo.toml -p mxc_schema_gen -- types --version 1.0.0 --out sdk/node/src/generated/v1_0_0/wire.ts
 */
/**
...
export type OneShotContainment = "process" | "processcontainer" | "lxc" | "bubblewrap" | "seatbelt" | "isolation_session" | "wslc";

/**
 * A complete one-shot `1.0.0` configuration request.
 */
