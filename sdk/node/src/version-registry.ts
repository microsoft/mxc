...
export const ContainmentRegistry: FieldRegistry = {
    ...
    macos_sandbox:      { addedIn: '0.5.0-alpha', deprecatedSince: '0.6.0-alpha', renamedTo: 'seatbelt' },
    seatbelt:           { addedIn: '0.6.0-alpha' },

    // Added in 0.6. Bubblewrap is stable in the current SDK surface; the
    // remaining concrete backends here still require --experimental.
    isolation_session:  { addedIn: '0.6.0-alpha', experimental: true },
    bubblewrap:         { addedIn: '0.6.0-alpha' },
