...
// (`Phase`, `IsolationSessionUser`, `IsolationSessionPhase`).
...
//   {Provision,Start}Config.user          IsolationSessionPhase.user / IsolationSessionUser
//
...
import type {
  Phase as WirePhase,
  IsolationSessionUser as WireIsolationUser,
...
// inspect method is not part of the wire contract) to wire `IsolationSessionUser`.
