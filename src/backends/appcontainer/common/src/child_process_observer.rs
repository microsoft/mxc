...
#[cfg(target_os = "windows")]
pub(crate) struct ChildProcessObserver {
    stop: Arc<AtomicBool>,
...
impl ChildProcessObserver {
    ...
    pub(crate) fn spawn(parent_pid: u32, poll_interval: Duration) -> Option<Self> {
    ...
    pub(crate) fn take_observed_count(mut self) -> usize {
