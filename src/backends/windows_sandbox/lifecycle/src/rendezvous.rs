...
/// for a slower CI environment happens in one place. Review G5.
...
/// across one-shot + state-aware so the I/O cadence is uniform; review G5.
...
/// without hanging the caller. Shared across one-shot + state-aware; review G5.
