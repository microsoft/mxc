...
//! by:
//!
//! - **`learning_mode_windows`**: extracts denials from ETW, converts
//!   into the `DeniedResource` shape declared here, and writes them
//!   to the denial channel.
...
//!
//! See `docs/learning-mode/architecture.md` for the box diagram.
