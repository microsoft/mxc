...
still reachable here through the state-aware lifecycle. Apple Container can be
named, but this increment returns [`ErrorCode::UnsupportedContainment`] before
creating resources.

### Apple Container (experimental config surface)

Apple Container requests require schema version `0.9.0-alpha`, an OCI image,
