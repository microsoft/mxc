...
pub fn build_request_from_json(request_json: &str) -> Result<SandboxRequest, Error> {
...
mod tests {
    ...
    fn managed_full_request_goldens_are_accepted_by_native_contract() {
        ...
        assert_eq!(ui.clipboard, crate::policy::ClipboardPolicy::Read);
        ...
        assert_eq!(ports[0].protocol, Some(crate::NetworkProtocol::Tcp));
