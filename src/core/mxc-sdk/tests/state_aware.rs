...
fn run_state_aware_json_rejects_non_dry_run_exec() {
    ...
    let json = r#"{"version":"0.10.0-alpha","phase":"exec","sandboxId":"isolationsession:abc","process":{"commandLine":"echo hi"}}"#;
    let err =
...
fn unregistered_backend_prefix_is_unsupported_containment() {
    let json = r#"{"version":"0.10.0-alpha","phase":"start","sandboxId":"nosuchbackend:abc123"}"#;
