...
//!
//! These types validate the published contract's JSON structure, local value
//! constraints, and explicit compatibility spellings. They preserve omitted
//! optional fields for a later adapter to normalize. Cross-field relationships,
//! backend support, and runtime semantics remain the responsibility of the
//! shared semantic parser after adaptation.
...
pub use request::{
    CaptureDenials, CaptureDenialsMode, Containment, Fallback, Filesystem, LaunchMethod, Lifecycle,
    Lxc, Process, ProcessContainer, ProcessContainerCapability, ProcessContainerNetwork,
    ProcessContainerUi, ProcessContainerUiIsolation, Request, RuntimeConfig, Seatbelt, Ui,
    UiClipboard, Version,
};
