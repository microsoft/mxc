...
fn provision_dispatch(isolation_session: Value) -> Value {
    branch(
...
/// published contract.
///
/// The document selects one of six closed request roots through nested
...
pub fn published_schema() -> Value {
    ...
    let provision = provision_dispatch(isolation_session);
...
mod tests {
    ...
    #[test]
    fn contains_all_six_concrete_roots() {
