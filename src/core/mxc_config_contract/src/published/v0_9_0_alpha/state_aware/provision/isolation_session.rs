...
use crate::published::v0_9_0_alpha::state_aware::provision::ProvisionPhase;
use crate::published::v0_9_0_alpha::{OptionalField, Telemetry, Version};
...
mod tests {
    use super::*;
    use crate::published::v0_9_0_alpha::{parse_request, ProvisionRequest, Request};
    ...
    fn generated_schema_requires_network() {
        let schema = crate::published::v0_9_0_alpha::published_schema();
