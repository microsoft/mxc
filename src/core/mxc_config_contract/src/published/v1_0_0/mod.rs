...
//! Wire types for the published `1.0.0` configuration contract.
//!
...
string_enum! {
    ...
    pub enum Version {
        /// The published `1.0.0` contract.
        V1_0_0 => ["1.0.0"],
    }
}

mod network;
/// The published `1.0.0` one-shot configuration contract.
mod one_shot;
mod primitives;
mod request;
#[cfg(feature = "schema-gen")]
mod schema;
mod stable;
/// The published `1.0.0` state-aware configuration contract.
mod state_aware;
mod wslc;
