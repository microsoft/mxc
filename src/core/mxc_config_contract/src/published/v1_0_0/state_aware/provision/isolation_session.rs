...
use crate::published::v1_0_0::state_aware::provision::ProvisionPhase;
use crate::published::v1_0_0::{OptionalField, Telemetry, Version};
...
mod tests {
    use super::*;
    use crate::published::v1_0_0::{parse_request, ProvisionRequest, Request};
    ...
    fn provision(fields: &str) -> String {
        format!(
            r#"{{"version":"1.0.0","phase":"provision","containment":"isolation_session"{fields}}}"#
        )
    }
    ...
    fn generated_schema_requires_network() {
        let schema = crate::published::v1_0_0::published_schema();
