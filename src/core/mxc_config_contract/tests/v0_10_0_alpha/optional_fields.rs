...
fn rejects_null_optional_fields() {
    let version = r#""version": "0.10.0-alpha""#;
    ...
    assert_invalid_cases(
        [
            ...
            ("test", version_and_process.as_str(), r#""test": null"#),
            (
                "test.message",
                version_and_process.as_str(),
                r#""test": {"message": null}"#,
            ...
            ("wslc", version_and_process.as_str(), r#""wslc": null"#),
            (
                "wslc.targetOs",
                version_and_process.as_str(),
                r#""wslc": {"targetOs": null}"#,
            ),
            (
                "wslc.image",
                version_and_process.as_str(),
            ...
            (
                "wslc.imageTarPath",
                version_and_process.as_str(),
                r#""wslc": {"imageTarPath": null}"#,
            ),
            (
                "wslc.cpuCount",
                version_and_process.as_str(),
                r#""wslc": {"cpuCount": null}"#,
            ),
            (
                "wslc.memoryMb",
                version_and_process.as_str(),
                r#""wslc": {"memoryMb": null}"#,
            ),
            (
                "wslc.gpu",
                version_and_process.as_str(),
            ...
            (
                "wslc.storagePath",
                version_and_process.as_str(),
                r#""wslc": {"storagePath": null}"#,
            ),
            (
                "wslc.portMappings",
                version_and_process.as_str(),
                r#""wslc": {"portMappings": null}"#,
            ),
            (
