...
fn rejects_missing_required_fields() {
    for json in [
        ...
        r#"{"version":"0.10.0-alpha","containment":"windows_sandbox"}"#,
...
fn rejects_null_required_fields() {
    for json in [
        ...
        r#"{"version":"0.10.0-alpha","phase":null,"containment":"windows_sandbox"}"#,
        r#"{"version":"0.10.0-alpha","phase":"provision","containment":null}"#,
    ] {
        assert_invalid(json);
    }
}
...
#[test]
fn rejects_backend_specific_fields() {
    for field in [
        r#""test": {}"#,
        r#""windowsSandbox": {}"#,
        r#""isolationSession": {}"#,
