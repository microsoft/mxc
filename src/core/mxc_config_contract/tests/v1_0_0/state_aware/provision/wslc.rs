...
use mxc_config_contract::published::v1_0_0::WslcProvisionRequest;
...
fn rejects_wrong_version_phase_or_containment() {
    for json in [
        ...
        r#"{"version":"1.0.0","phase":"start","containment":"wslc"}"#,
        r#"{"version":"1.0.0","phase":"provision","containment":"windows_sandbox"}"#,
        r#"{"version":"1.0.0","phase":"provision","containment":"microvm"}"#,
        r#"{"version":"1.0.0","phase":"provision","containment":"hyperlight"}"#,
        r#"{"version":"1.0.0","phase":"provision","containment":"vm"}"#,
    ] {
        assert_invalid(json);
    }
}
