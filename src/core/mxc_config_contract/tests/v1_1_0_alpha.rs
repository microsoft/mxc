...
mod common;
#[path = "v1_1_0_alpha/enums.rs"]
mod enums;
#[path = "support/exact.rs"]
mod exact_test_support;
#[path = "v1_1_0_alpha/experimental.rs"]
mod experimental;
#[path = "support/fixture_corpus.rs"]
mod fixture_corpus;
#[path = "v1_1_0_alpha/fixtures.rs"]
mod fixtures;
#[path = "v1_1_0_alpha/network.rs"]
mod network;
#[path = "support/one_shot.rs"]
mod one_shot;
#[path = "v1_1_0_alpha/one_shot_backend_sections.rs"]
mod one_shot_backend_sections;
#[path = "support/optional_fields.rs"]
mod optional_fields;
#[path = "v1_1_0_alpha/request.rs"]
mod request;
#[path = "v1_1_0_alpha/seatbelt.rs"]
mod seatbelt;
#[path = "support/state_aware.rs"]
mod state_aware;
#[path = "v1_1_0_alpha/state_aware/provision/mod.rs"]
mod state_aware_provision;
#[path = "v1_1_0_alpha/wslc.rs"]
mod wslc;
