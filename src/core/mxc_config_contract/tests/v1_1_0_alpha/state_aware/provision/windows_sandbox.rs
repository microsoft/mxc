...
fn rejects_missing_required_fields() {
    for json in [
        ...
        r#"{"version":"1.1.0-alpha","containment":"windows_sandbox"}"#,
...
fn rejects_null_required_fields() {
    for json in [
        ...
        r#"{"version":"1.1.0-alpha","phase":null,"containment":"windows_sandbox"}"#,
        r#"{"version":"1.1.0-alpha","phase":"provision","containment":null}"#,
    ] {
        assert_invalid(json);
    }
}
