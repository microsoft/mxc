...
//! `processcontainer_common::guarded_capture`'s DI traits.
//!
//! `processcontainer_common` cannot depend on `plm` directly (see
//! `processcontainer_common::guarded_capture`'s module docs for the crate-layering
...
use processcontainer_common::guarded_capture::{
