...
mod tests {
    ...
    #[test]
    fn exact_policy_builder_rejects_development_containment_before_v0_10() {
    ...
    use super::{
        build_request, NetworkAction, NetworkEgressSection, NetworkIngressSection, NetworkSection,
        ProxySpec, RuntimeConfigSection, SandboxPolicy,
    };
