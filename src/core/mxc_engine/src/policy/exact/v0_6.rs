...
pub(super) fn build(input: &PreparedInput<'_>) -> Result<contract::Request, MxcError> {
    ...
    if network_format == NetworkFormat::Directional {
        return Err(error(
    ...
    if matches!(containment, Containment::Wslc(_)) {
        return Err(error(
            "WSLC containment requires schema version 0.10.0-alpha",
        ));
    }
    ...
    Ok(contract::Request {
        version: contract::Version::V0_6_0Alpha,
        ...
        process: contract::Process {
            ...
            cwd: contract::OptionalField::default(),
            env: contract::OptionalField::default(),
        ...
        fallback: contract::OptionalField::default(),
        network: contract::OptionalField::present(contract::Network {
            ...
            allowed_hosts: match policy.network.as_ref() {
                ...
                None => contract::OptionalField::default(),
            },
