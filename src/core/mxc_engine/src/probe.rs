...
pub fn available_backends() -> Vec<AvailableBackend> {
    ...
    #[cfg(target_os = "windows")]
    {
        use processcontainer_common::fallback_detector::is_base_container_usable;
        ...
        windows_backends(
            ...
            ProcessContainerCapabilities {
                capture_denials: capture_denials_available(
                    processcontainer_common::base_container_runner::BaseContainerRunner::is_capture_denials_usable(),
                    guarded_capture::is_available(),
                ),
                filesystem_denied_paths: processcontainer_common::base_container_runner::BaseContainerRunner::supports_native_denied_paths(),
                ingress_host_loopback_allow: processcontainer_common::base_container_runner::BaseContainerRunner::supports_ingress_host_loopback_allow(),
            },
        )
    }
...
#[cfg(target_os = "windows")]
fn windows_backends(
    tier: processcontainer_common::fallback_detector::IsolationTier,
    ...
    if tier == processcontainer_common::fallback_detector::IsolationTier::BaseContainer {
...
) -> processcontainer_common::fallback_detector::IsolationTier {
    use processcontainer_common::fallback_detector::IsolationTier;
