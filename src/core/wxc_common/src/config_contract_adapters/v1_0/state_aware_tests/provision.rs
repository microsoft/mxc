...
fn source(fields: &str) -> String {
    format!(
        r#"{{"version":"1.0.0","phase":"provision","containment":"isolation_session","network":{{"egress":{{"default":"allow"}},"ingress":{{"default":"allow","hostLoopback":"allow"}}}}{fields}}}"#
    )
}
...
fn wslc_source(fields: &str) -> String {
    format!(r#"{{"version":"1.0.0","phase":"provision","containment":"wslc"{fields}}}"#)
}
