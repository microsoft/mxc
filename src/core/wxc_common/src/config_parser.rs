...
mod tests {
    ...
    #[test]
    fn schema_version_0_5_now_rejected() {
        // Phase 3b raised the floor to 0.6.0-alpha; 0.5.0-alpha is back-dated.
    ...
    #[test]
    fn schema_version_0_4_now_rejected() {
        // Phase 3b raised the floor to 0.6.0-alpha; 0.4.0-alpha is back-dated.
