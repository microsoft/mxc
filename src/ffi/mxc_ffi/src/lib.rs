...
//!   [`mxc_io_spawn_request`] and [`mxc_io_state_aware_exec`] transfer native
//!   stdio endpoints to the caller while retaining timeout, kill, wait,
//!   metadata, and teardown control on a native lifecycle thread.
