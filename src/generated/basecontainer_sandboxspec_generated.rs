...
pub mod sandbox_tech_spec_layout {
    ...
    pub struct SandboxSpecBuilder<'a: 'b, 'b> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b> SandboxSpecBuilder<'a, 'b> {
        #[inline]
    ...
    pub unsafe fn root_as_sandbox_spec_unchecked(buf: &[u8]) -> SandboxSpec<'_> {
        flatbuffers::root_unchecked::<SandboxSpec>(buf)
    }
    #[inline]
    ...
    pub unsafe fn size_prefixed_root_as_sandbox_spec_unchecked(buf: &[u8]) -> SandboxSpec<'_> {
        flatbuffers::size_prefixed_root_unchecked::<SandboxSpec>(buf)
    }
    ...
    #[inline]
    pub fn finish_sandbox_spec_buffer<'a, 'b>(
    ...
    #[inline]
    pub fn finish_size_prefixed_sandbox_spec_buffer<'a, 'b>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        root: flatbuffers::WIPOffset<SandboxSpec<'a>>,
    ) {
        fbb.finish_size_prefixed(root, Some(SANDBOX_SPEC_IDENTIFIER));
    }
} // pub mod SandboxTechSpecLayout
