...
//! LSA privilege management for the denial shim.
//!
//! `mxc-learning-mode-shim` runs as `LocalService` (least-privilege account)
...
//! plenty of MS-shipped services) and harmless without the shim
//! binary to use it.
//!
