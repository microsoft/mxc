...
// Phase 0 scaffolding crate. These crates are imported from the
// `user/gudge/projfs_t3_spike` branch as the Phase 0 baseline and will
// be promoted (and these crates deleted) during Phase A. Suppress
// newer-clippy style lints rather than churn the scaffolding code.
#![allow(
