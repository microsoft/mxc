...
/// Clean up a sandbox: delete the AppContainer profile and remove the
/// tracking registry entry. Best-effort and idempotent — failures are
/// logged but do not propagate as errors.
