...
`tests/examples/`, where `scripts/versioning/validate-configs.js` selects each
document's exact registered schema from its `version`; these would fail because
they describe a different contract.
