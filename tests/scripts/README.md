...
| `run_base_container_network_tests.ps1` | Thin launcher for the Rust BaseContainer 0.7/0.8 direct-policy and packaged-proxy E2E matrix | Rust toolchain, BaseContainer PSEC APIs, and loose package registration (Developer Mode or trusted developer package policy) |
