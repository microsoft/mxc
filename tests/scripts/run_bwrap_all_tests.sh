...
run_test "Bubblewrap Cwd Preflight" "$SCRIPT_DIR/run_bwrap_cwd_preflight_test.sh"
...
run_test "Bubblewrap Provider Loss" "$SCRIPT_DIR/run_bwrap_provider_loss_test.sh"
