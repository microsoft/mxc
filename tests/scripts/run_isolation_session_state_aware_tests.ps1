...
# checks. Those hard-coded a runtime class name, so they stopped tracking what
# the code actually activates once the backend moved to the Preview API — a
# gate that no longer reflects the thing it guards can pass or skip for the
# wrong reason. Asking the binary under test what it supports cannot drift.
